    ...
    <div className="flex flex-col h-full overflow-y-auto pb-24 px-1">
      <div className="flex-1 flex flex-col space-y-8">
        ...
        <div className="text-center space-y-3 pt-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-teal-50 text-teal-600 border border-teal-100 shadow-sm mb-2 animate-float">
            <Compass size={32} />
          </div>
          <h2 className="text-4xl font-bold text-calm-olive serif-title">Libera tu Mente</h2>
          <p className="text-sm text-calm-olive/70 max-w-sm mx-auto leading-relaxed">
        ...
        <div className="space-y-6 calm-card p-6 border border-calm-sage-100/60 bg-white/70 shadow-sm">
          <div className="text-center space-y-1">
            <h3 className="text-lg font-bold text-calm-olive">
              ¿Qué te ayuda a desconectar?
            </h3>
            <p className="text-xs text-calm-olive/50">
          ...
          <div className="space-y-5">
            {CATEGORIES.map((cat) => (
              <div key={cat.id} className="space-y-2.5">
                <h4 className="text-xs font-bold text-calm-sage-700 uppercase tracking-widest flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className={`px-3.5 py-2 rounded-xl border text-xs transition-all duration-200 text-left cursor-pointer select-none font-medium ${
                          isSelected
                            ...
                            : 'border-calm-sage-100/60 bg-white/50 text-calm-olive/80 hover:border-calm-sage-300 hover:bg-white'
                        }`}
                      >
                        {sub.label}
                      </button>
      ...
      <div className="pt-6">
        <button
          ...
          className="w-full py-4 bg-calm-sage-500 hover:bg-calm-sage-600 active:scale-[0.99] text-white rounded-2xl font-bold text-base flex items-center justify-center space-x-2 transition-all shadow-lg shadow-calm-sage-200/50"
        >
